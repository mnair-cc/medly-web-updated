...
export default function LockOverlay() {
  return (
    <div className="absolute inset-0 backdrop-blur-[2px] bg-black/50 flex items-center justify-center z-[1100]">
      <div className="bg-white rounded-[8px] text-center shadow-[0_0_32px_rgba(0,0,0,0.2)] w-[90%] md:w-[30%] overflow-hidden relative flex flex-col items-center md:max-h-[75%]">
        ...
        <div className="flex-1 px-6 pt-4 pb-8 flex flex-col justify-center items-center">
          <h1 className="text-3xl mb-2 font-rounded-heavy">Unlock all questions</h1>
