  ...
  const saveMarkingResult = async (
    ...
    try {
      switch (sessionType) {
        ...
        case SessionType.QuestionBank: {
          await nextApiClient.post(
            `/user/subjects/${subjectId}/question-bank-sessions/${questionBankSessionId}`,
            markingResult
          );
          break;
        }
        case SessionType.Paper: {
          await nextApiClient.post(
