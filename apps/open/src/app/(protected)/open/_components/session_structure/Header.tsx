  ...
  return (
    <div className="flex flex-row w-full items-center justify-center gap-5 py-4 z-10">
      ...
      >
        ...
        <div className="hidden flex-1 flex justify-left items-center">
          ...
          {sessionType === SessionType.MockSession &&
            ...
            !hasFinished &&
            !isReadOnly && (
              <div className="flex flex-row items-center gap-1 flex-nowrap whitespace-nowrap">
                {showTimer ? (
                  <div
        ...
        <div className="flex flex-1 justify-end items-center gap-2">
          {/* DEBUG: Page type switcher */}
          {/* {setPageType && (
            <div className="flex gap-1 border border-red-500 rounded p-1 text-xs">
              <button
                className={`px-2 py-1 rounded ${pageType === QuestionSessionPageType.Document ? "bg-red-500 text-white" : "bg-gray-200"}`}
                onClick={() => setPageType(QuestionSessionPageType.Document)}
              >
                Doc
              </button>
              <button
                className={`px-2 py-1 rounded ${pageType === QuestionSessionPageType.Notes ? "bg-red-500 text-white" : "bg-gray-200"}`}
                onClick={() => setPageType(QuestionSessionPageType.Notes)}
              >
                Notes
              </button>
              <button
                className={`px-2 py-1 rounded ${pageType === QuestionSessionPageType.Flashcards ? "bg-red-500 text-white" : "bg-gray-200"}`}
                onClick={() => setPageType(QuestionSessionPageType.Flashcards)}
              >
                Flash
              </button>
              <button
                className={`px-2 py-1 rounded ${pageType === QuestionSessionPageType.Practice ? "bg-red-500 text-white" : "bg-gray-200"}`}
                onClick={() => setPageType(QuestionSessionPageType.Practice)}
              >
                Practice
              </button>
            </div>
          ...
          {(() => {
            ...
            return (
              <a
                ...
                className="hidden md:flex flex-row items-center gap-1 font-rounded-bold text-[15px] px-3 h-9 rounded-[8px] bg-[#F9F9FB] hover:bg-[#F0F0F5] whitespace-nowrap"
                onClick={() => {
              ...
              >
                ...
                >
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_614_1247_header)">
                    ...
                    <defs>
                      <clipPath id="clip0_614_1247_header">
          ...
          {sessionType === SessionType.LessonSession && (
            ...
            >
              <button
                ...
                className="flex flex-row items-center gap-1 font-rounded-bold text-[15px] px-2 pr-3 h-9 rounded-[8px] bg-[#F9F9FB] hover:bg-[#F0F0F5]"
              >
                {selectedMode === "learn" ? (
                  <svg
                    width="28"
