...
/**
 * Floating header button for mobile views.
 * Shows logo, title, and sidebar toggle icon.
 */
  ...
  return (
    <div className="absolute top-2 left-3 z-50">
      <button
        ...
        className="flex items-center gap-2 px-4 py-3 bg-white rounded-[12px] shadow-[0_1px_4px_rgba(0,0,0,0.15)] active:scale-[0.98] transition-all duration-150 ease-out"
      >
        <MedlyLogoIcon />
        <span className="font-rounded-bold text-[14px] truncate max-w-[120px]">
          {title}
        </span>
        {/* Sidebar toggle icon */}
        <svg
