...
import { LearnFlowQuestionContent, InputMode } from "../../../types";
...
const QuestionBlock: React.FC<QuestionBlockProps> = React.memo(
  ({
    ...
    const { shuffledOptions, correctIndex } = useMemo(() => {
      ...
      const correctOriginalIndex = content.correct_option_index;
    ...
    }, [content.options, content.correct_option_index, blockKey]);
    ...
    return (
      ...
      >
        ...
        {content.diagram_svg && (
          <div className="flex justify-center mt-4 w-full max-w-full overflow-hidden">
            <div className="w-full max-w-[640px] overflow-hidden">
              <MemoizedMarkdown content={content.diagram_svg} />
            </div>
          </div>
        )}
